...
__help__ = """
 - /id: بدون ریپلای=نمایش آیدی گروه با ریپلای=نمایش آیدی کاربر
 - /info: گرفتن اطلاعات کاربر
 - /gdpr: پاک کردن اطلاعات خود از دیتابیس ربات

"""

__mod_name__ = "اطلاعات"
