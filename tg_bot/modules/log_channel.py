...
if is_module_loaded(FILENAME):
    ...
    def logging(bot: Bot, update: Update):
        ...
        if log_channel:
            ...
            message.reply_text(
                "این چنل ها میتوانند به این گروه پیام بفرستند: {} (`{}`)".format(escape_markdown(log_channel_info.title),
                                                                                 log_channel),
                parse_mode=ParseMode.MARKDOWN)

        else:
            message.reply_text("هیچ چنلی برای این گروه ثبت نشده!")
    ...
    def setlog(bot: Bot, update: Update):
        ...
        if chat.type == chat.CHANNEL:
            message.reply_text("حالا فوروارد کن /setlog را به گروه!")
            ...
            bot.send_message(chat.id, "چنل با موفقیت ثبت شد!")

        else:
            message.reply_text("این ۳ کار را برای ثبت چنل انجام بده:\n"
                               " - اضافه کردن من به چنل\n"
                               " - ارسال /setlogبه چنل\n"
                               " - فوروارد /setlog از چنل به گروه\n")
    ...
    def unsetlog(bot: Bot, update: Update):
        ...
        if log_channel:
            ...
            message.reply_text("لیست چنل ها ریست شد.")

        else:
            message.reply_text("هیچ چنلی هنوز ثبت نگردیده!")
    ...
    __help__ = """
*فقط ادمین ها:*
- /logchannel:اطلاعات مربوط به چنل گروه
- /setlog:تنظیم چنل برای گروه
- /unsetlog:حذف چنل برای گروه

تنظیم کردن کانال برای گروه با ۳ اقدام زیر:
- اضافه کردن ربات به چنل بعنوان ادمین!
- ارسال /setlog در چنل
- فوروارد کردن /setlog از چنل به گروه
"""
