...
PM_START_TEXT = """
سلام ☘️{}☘️, اسم من {}💋! اگر هر سوالی داری که چطور من کار میکنم, بخون /help - و یا به من پی ام بده @mhhmtm.

من ربات رایگان برای مدیریت گروه هستم.
تو میتونی دستورات منو با این ببینی /help.
"""

HELP_STRINGS = """
سلام🌺! اسم من *{}*💋.
من یک ربات مدیریت گروه رایگان با چند مورد جالب هستم! برای ایده گرفتن از برخی از موارد زیر نگاهی بیندازید:
چیزهایی که می توانم به شما کمک کنم.

دستورات:
 - /start: استارت ربات
 - /help: ارسال تمامی دستورات
 - /help <نام دستور>
 - /donate: حمایت مالی از من
 - /settings:
   - in PM: تنظیمات شما را برای همه ماژول های پشتیبانی شده ارسال می کند.
   - in a group: تمام تنظیمات آن گروه را به شما ارسال میکنم.

{}
ودر ادامه:
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "\nهمه ی دستورات با این دو اجرا میشوند / یا !.\n")

DONATE_STRING = """سلام🌺, متشکرم ازت برای حمایت مالی به من پی ام بده @mhhmtm !"""
